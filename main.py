"""Документация для моей новой программы
которую отправлю сейчас на гитхаб."""
...
def attack(char_name: str, char_class: str) -> str:
    ...
    return f'{char_name} совершил стандартную атаку'
...
def special(char_name: str, char_class: str) -> str:
    """Проверяет применение специального оружия."""
    if char_class == 'warrior':
    ...
    return f'{char_name} оружие не применял'
...
def choice_char_class() -> str:
    """Выберает персонажа которым собираешься играть в эту прекрасную игру."""
    approve_choice: str = ''
    char_class: str = ''
